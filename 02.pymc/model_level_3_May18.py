...
# %%
#####
wintering_prefix = f'{out_path}/wintering_model_level_3_May18_{city_index}'
breeding_prefix = f'{out_path}/breeding_model_level_3_May18_{city_index}'
input_final_df_prefix = f'{out_path}/final_df_model_level_3_May18_{city_index}'
...
try:
    ...
    ####### parsing results
    res = parse_breeding_results(city_index, idata, wintering_df, ess_, rhat_, bmfi_, train_roc_auc, test_roc_auc,
...
try:
    ...
    ####### parsing results
    res = parse_breeding_results(city_index, idata, breeding_df, ess_, rhat_, bmfi_, train_roc_auc, test_roc_auc,
                          X_train_Cropland_std, X_train_Built_up_std)
